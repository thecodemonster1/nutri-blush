      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Your comprehensive business management solution for inventory
            tracking, sales reporting, and administrative control.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <p className="text-gray-600 mb-6">
                Analyze sales performance, track revenue, and generate
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              ...
              <p className="text-gray-600 mb-6">
                Configure settings, manage users, and control all aspects of
                your business.
              </p>
              <Link
                href="/admin"
